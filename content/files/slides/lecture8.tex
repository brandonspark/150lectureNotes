...
\begin{frame}[fragile]
  ...
  \footnotetext[2]{Some languages actually do call this "generics".}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[3]{It's not really important to know why it's called this.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  our function is 
  \code{bool * int * 'c * (unit -> int * 'c) -> int * 'c}.\footnotemark 

  \footnotetext[5]{A very useful type.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[6]{The same way that an annual tuition increase is a surprise.}
\end{frame}
