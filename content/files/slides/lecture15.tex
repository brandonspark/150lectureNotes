...
\begin{frame}[fragile]
  ...
  \footnotetext[1]{At least, in principle. In actuality, we have no guarantee
...
\begin{frame}[fragile]
  ...
  \footnotetext[2]{It is technically misleading to say "of type \code{'a}",
...
\begin{frame}[fragile]
  ...
  \footnotetext[3]{\color{blue}\href{https://en.wikipedia.org/wiki/Pig_Latin}{See this reference for more}}
\end{frame}
