...
\begin{frame}[fragile]
  ...
  \footnotetext[1]{Using a language very similar to the one you will learn in this class.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[2]{Yes, like Harry Potter.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[3]{Especially the last one.}
\end{frame}
