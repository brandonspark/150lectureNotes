...
\begin{frame}[fragile]
  ...
  There will always be a need for software, and by loose association, software engineers.
...
\begin{frame}[fragile]
  ...
  In English:
  \begin{quote}
   It is impossible to definitively, correctly answer yes or no for any property of a
