...
\begin{frame}[fragile]
  ...
  This \code{sort} function doesn't do the "same essential thing", however---its
  behavior depends on the \code{cmp} function it receives as input!
