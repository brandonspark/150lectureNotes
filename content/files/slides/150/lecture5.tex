...
\begin{frame}[fragile]
  ...
  \begin{center}
    \begin{tikzpicture}
      [level distance=10mm,
      every node/.style={circle,inner sep=2pt, draw=black!80, thick, fill=black!15!white},
...
\begin{frame}[fragile]
  ...
  Let's see some examples of trees, and how they would be pictured visually\footnote{
    It can be confusing to type out a tree in text, so
...
\begin{frame}[fragile]
  ...
  \begin{minipage}{0.32\textwidth}
    \begin{center}
      \begin{tikzpicture}
        [level distance=12mm,
        every node/.style={circle,inner sep=4pt, draw=black!80, thick, fill=black!15!white},
  ...
  \begin{minipage}{0.32\textwidth}
    \begin{center}
      \begin{tikzpicture}
        ...
        {\color{black!15!red}left}-{\color{black!10!green}root}-{\color{black!10!blue}right}
    \end{center}
  \end{minipage}
  \begin{minipage}{0.32\textwidth}
    \begin{center}
      ...
      {\color{black!15!green}root}-{\color{black!10!red}left}-{\color{black!10!blue}right}
    \end{center}
  \end{minipage}
  \begin{minipage}{0.32\textwidth}
    \begin{center}
      \begin{tikzpicture}
        ...
        {\color{black!15!red}left}-{\color{black!10!blue}right}-{\color{black!10!green}root}
    \end{center}
  \end{minipage}
...
\begin{frame}[fragile]
  ...
  \code{id e} $\eeq$ \code{e}, for an arbitrary expression \code{e}!}\footnote{
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \begin{tikzpicture}
      \node[shape=rectangle,draw=black, fill=black!15!white, text width=3cm] (M1) at (-3,2) {totality citation};
      \node[shape=rectangle,draw=black, fill=black!15!white, text width=3cm] (M2) at (1.5,2) {valuability of \code{e}};
      \node[shape=rectangle,draw=black, fill=black!15!white, text width=5cm] (M3) at (7,2) {ability to use theorem which \\ relies on \code{e} being valuable};
...
\begin{frame}[plain]
  \begin{center}
    {\huge \color{presentColor} \intermedium{Post-lecture attendance poll}}

    \vspace{10pt}

    \color{presentColor} \intermedium{Password: JADEN}

    \vspace{\fill}

    \includegraphics[scale=0.35]{jaden.jpeg}
  \end{center}
\end{frame}
