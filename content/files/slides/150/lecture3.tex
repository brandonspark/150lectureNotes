...
% DOCUMENT CLASS AND PACKAGE USE
    ...
    \newcommand{\bgColor}{bcd1e8}      % the color of the background of the slide
...
\begin{frame}[fragile]
  \frametitle{Recap: Extensional Equivalence}
...
\begin{frame}[fragile]
  ...
  \customBox{Example}{ This sentence is recursive. }
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \includegraphics[scale=0.25]{mask_reveal}
  \end{center}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    }, which is the empty list of type \code{t list} \pause
...
\begin{frame}[fragile]
  ...
  \ihBox{}{\, Assume \code{fast_pow (n, i)} $\eeq$ \code{pow (n, i)}, for all \code{0 <= i < k},
  for some \code{k}}
...
\lecturePassword{RECURSIONISMYFRIEND}
