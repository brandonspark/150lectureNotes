...
\begin{frame}[fragile]
  ...
  For simplicity, we will assume that our forking model allows us to
  fork any number of graphs at once:
  ...
  other, but nobody has time for that\footnote{Literally. Assuming only binary forking
  leads to slightly different cost bounds.}.
