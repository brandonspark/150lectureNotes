...
% DOCUMENT CLASS AND PACKAGE USE
    ...
    \subtitle{Giving our types more color} % TODO
    \date{04 June 2026} % TODO
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \begin{tikzpicture}
      [level distance=15mm,
      every node/.style={circle,inner sep=4pt, draw=black!80, thick, fill=node_color},
...
\begin{frame}[fragile]
  ...
  \makebox[0.8\textwidth][c]{
    \begin{tikzpicture}
      \node[shape=rectangle,draw=black,fill=node_color] (L1) at (-4.5,0) {\small \code{int * real}};

      \node[] (E2) at (-2,-1) {\textellipsis};
      \node[shape=rectangle,draw=black,fill=node_color] (L2) at (-1.8,0) {\small \code{bool * 'b}};

      \node[shape=rectangle,draw=black,fill=node_color] (L3) at (0.8,0) {\small \code{int list}};

      \node[shape=rectangle,draw=black,fill=node_color] (L4) at (3.2,0) {\small \code{unit list}};

      \node[shape=rectangle,draw=black,fill=node_color] (L5) at (5.8,0) {\small \code{unit tree}};

      \node[shape=rectangle,draw=black,fill=node_color] (L6) at (8.5,0) {\small \code{int tree}};

      \node[] (EL) at (-4,2) {\textellipsis};
      \node[shape=rectangle,draw=black,fill=node_color] (M1) at (-1,2) {\code{'a * 'b}};
      \node[shape=rectangle,draw=black,fill=node_color] (M2) at (2,2) {\code{'a list}};
      \node[shape=rectangle,draw=black,fill=node_color] (M3) at (5,2) {\code{'a tree}};
      \node[] (ER) at (8,2) {\textellipsis};

      \node[shape=rectangle,draw=black,fill=node_color] (T) at (2,4) {\code{'a}};
...
\begin{frame}[fragile]
  ...
  \customColorBox{red}{white}{Warning}{\, Be careful not to confuse being an \term{instance} of a type with
