...
\begin{frame}[fragile]
  ...
  \begin{center}
    \includegraphics[scale=0.25]{open}
  \end{center}
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \includegraphics[scale=0.4]{opaque_cast}
  \end{center}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{center}
    \includegraphics[scale=0.35]{rep}
  \end{center}

  We see that the actual value we obtain in either case, when we expose the
  inner representation, is \code{[2, 1]} and \code{[1, 2]}.
