...
\begin{frame}[fragile]
  ...
  the tens of millions of software developers around the world? Especially
  those using AI agents to write the code?
...
\begin{frame}[fragile]
  ...
  before you start training the model and then decide to go on a vacation to France for
  two weeks.
