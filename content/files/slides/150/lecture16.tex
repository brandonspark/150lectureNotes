...
\begin{frame}[fragile]
  ...
  Note that the \code{ins} function is written as not taking in the
  key-value pair \code{(k, v)} explicitly, as it inherits it from being
  in the body of \code{insert}.
\end{frame}
