...
\begin{frame}[fragile]
  ...
  \footnotetext[1]{You can also use a tape measure.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[2]{Recall that the $c_1$ term is obtained via the constant amount
...
\begin{frame}[fragile]
  ...
  \footnotetext[4]{We will usually specify whenever we have a particular way we want to 
...
\begin{frame}[fragile]
  ...
  \footnotetext[5]{Life is, sometimes.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  $O(n \log n)$. \footnotemark

  \footnotetext[6]{There are several things we elided to come to this bound. We decided to 
...
\begin{frame}[fragile]
  ...
  \footnotetext[7]{Exercise, reader, etc etc.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \only<3>{\footnotetext[8]{Second only to fixing your parents' printer.}}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[9]{Well, quick sort too. But we will discuss merge sort for today.}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \footnotetext[10]{Here, we use the notation $W_{\code{merge}}(\frac{n}{2}, \frac{n}{2})$ because
...
\begin{frame}[fragile]
  ...
  Where $n$ is the length of the list \code{L} in the expression \code{msort L}\footnotemark:
  \begin{align*} 
    & S_{\code{msort}}(n) \\
  ...
  \footnotetext[11]{Base cases same as work.}
\end{frame}
